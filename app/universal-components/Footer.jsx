...
export default function Footer() {
  ...
  <footer className="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 m-5 mb-0">
    ...
    <div className="col mb-3 text-center">
      ...
      <ul className="nav flex-column align-items-center">
        ...
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Courses</a></li>
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Syllabus</a></li>
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Pricing</a></li>
      </ul>
    </div>

    <div className="col mb-3 text-center">
      <h5 className='mb-4'>Whom we serve</h5>
      <ul className="nav flex-column align-items-center">
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">School Students</a></li>
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">College Students</a></li>
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Educational Institutes</a></li>
        <li className="nav-item mb-2"><a href="#" className="nav-link p-0 text-muted">Private College</a></li>
      </ul>
    </div>

    <div className="col mb-3 text-center contact">
  ...
  <div className="border-top">
    <div className="container py-3">
      <p className="text-center mb-0">© 2024-25 Geeta University. All rights reserved.</p>
    </div>
  </div>
</div>
    </>
